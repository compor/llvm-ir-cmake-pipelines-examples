...
PIPELINES="basicbc;loopc14n;link;binary"
...
CMAKE_OPTIONS="${CMAKE_OPTIONS} -DLLVMIR_PIPELINES_COMPOUND=${COMPOUND_PIPELINES}"
CMAKE_OPTIONS="${CMAKE_OPTIONS} -DLLVMIR_PIPELINES_COMPOUND_GROUP1=basicbc;link;loopc14n;binary"
